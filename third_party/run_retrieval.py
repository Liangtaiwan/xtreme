...
def main():
    ...
    parser.add_argument("--threshold", type=float, default=-1, help="Threshold (used with --output)")
    parser.add_argument("--embed_size", type=int, default=768, help="Threshold (used with --output)")
    parser.add_argument("--pool_type", type=str, default="mean", help="pooling over work embeddings")
    ...
    parser.add_argument(
        "--output_dir", default=None, type=str, required=True, help="The output directory",
    )
    parser.add_argument("--log_file", default="train", type=str, help="log file")

    parser.add_argument(
        "--task_name", default="bucc2018", type=str, required=True, help="The task name",
    )
