...
def main():
    ...
    parser.add_argument(
        ...
        help="By default removes fused tokens",
        default=False,
        action="store_true",
    )
    parser.add_argument(
        "--remove_deprel_suffixes",
        help="Restrict deprels to the common universal subset, e.g. nmod:tmod becomes nmod",
        default=False,
        action="store_true",
    )
    parser.add_argument(
        "--remove_node_properties",
        help="space-separated list of node properties to remove: form, lemma, cpostag, postag, feats",
        choices=["form", "lemma", "cpostag", "postag", "feats"],
        metavar="prop",
        type=str,
        nargs="+",
    )
    ...
    parser.add_argument(
        "--remove_arabic_diacritics", help="remove Arabic short vowels", default=False, action="store_true"
    )
    ...
    POSRANKPRECEDENCEDICT[
        "default"
    ] = "VERB NOUN PROPN PRON ADJ NUM ADV INTJ AUX ADP DET PART CCONJ SCONJ X PUNCT ".split(" ")
    ...
    for s in modif_treebank:
        ...
        s.filter_sentence_content(
            args.replace_subtokens_with_fused_forms,
            args.lang,
            current_pos_precedence_list,
            args.remove_node_properties,
            args.remove_deprel_suffixes,
            args.remove_arabic_diacritics,
        )
    ...
    cio.write_conll(
        ...
        args.output,
        args.output_format,
        print_fused_forms=args.print_fused_forms,
